...
keyboard_candidates.add_button('Добавить в избранные',
                               color=VkKeyboardColor.POSITIVE)
keyboard_candidates.add_button('Больше не показывать',
                               color=VkKeyboardColor.NEGATIVE)
keyboard_candidates.add_line()
keyboard_candidates.add_button('Посмотреть другой вариант',
                               color=VkKeyboardColor.SECONDARY)
keyboard_candidates.add_line()
keyboard_candidates.add_button('Вывести список избранных',
                               color=VkKeyboardColor.SECONDARY)
